  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:cn(
          "bg-zinc-900 text-zinc-50", // Estado normal
          "hover:bg-zinc-900 hover:text-zinc-50", // Al pasar el cursor
          "focus:bg-zinc-900 focus:text-zinc-50", // Al recibir foco
          "aria-selected:bg-zinc-900 aria-selected:text-zinc-50", // Estado seleccionado
          "dark:bg-zinc-50 dark:text-zinc-900", // Tema oscuro
          "dark:hover:bg-zinc-50 dark:hover:text-zinc-900", // Hover en tema oscuro
          "dark:focus:bg-zinc-50 dark:focus:text-zinc-900" // Focus en tema oscuro
        ),
